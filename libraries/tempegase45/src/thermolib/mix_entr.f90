...
! //                                                                  //
! //  SUBROUTINE mixture_entropy                                      //
! //                                                                  //
! //  Input:  nsp         number of species in the calculation        //    
...
! //                                                                  //
! //  Output: entro(8)      array of  entropies                       //
! //              1           complete                                //
! //              2           translation                             //
! //              3           rotation (anha=0)                       //
! //              4           vibration (anha=0)                      //
...
! //              8           not used                                //
! //                                                                  //
! //  This subroutine provides the  entropies of the mixture          //
...
!
      ...
      REAL(kind=8) var,T,TNEQ(4),entro(8),x(:),sent(8),varsent
!
...
101           FORMAT (11x,'Routine: mixture_entropy. Value:',d15.8)
...
102   FORMAT (11x,'Routine: mixture_entropy. Index:',i3,' Value:',d15.8)
...
103       FORMAT (11x,'Routine: mixture_entropy. Value:',d15.8)
      ...
      END DO
!     ------------------------------------------------------------------
!     Build entropy array by recursive calls to species energies
...
!     ------------------------------------------------------------------
      DO i=1,nsp
          ...
          IF (varsent.GT.1.0d-14) THEN
              CALL SPECIES_ENTROPY (i,varsent,T,TNEQ,&
     &flg_anha,mode,flg_neq,flg_stop,flg_termo,sent)
          ENDIF
          DO j=1,8
              entro(j)=entro(j)+sent(j)*x(i)
          END DO
      END DO
!
!     Error handling

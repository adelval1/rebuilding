...
! //                                                                  //
! //  Output: cv(8)        array of  specific heats                   //
...
! //  computed from the cv of individual species computed from        //
! //  statistical mechanics. It works for cv per mole or cv per mass  //
...
!
      ...
      REAL(kind=8) T,TNEQ(4),cv(8),x(:),sent(8)
!
...
101           FORMAT (11x,'Routine: cv_frozen. Value:',d15.8)
...
102   FORMAT (11x,'Routine: cv_frozen. Index:',i3,' Value:',d15.8)

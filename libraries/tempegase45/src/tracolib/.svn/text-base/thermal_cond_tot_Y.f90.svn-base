REAL(kind=8) FUNCTION thermal_cond_tot_y(T_NEQ)
...
!*****************************************************************
    ...
    REAL(kind=8) :: Devoto_lambda_electron,Yos_lambda_reactive_nanni 
    ...
    write(*,*)"thermal_cond_tot_nanni started - YOS"   
    ...
    k_reactive = Yos_lambda_reactive_nanni (T_NEQ(1))

    write(*,*)"k_reactive",k_reactive    

    thermal_cond_tot_y = k_trans + k_rot + k_vib + k_electronic &
   & + k_electron + k_reactive


END FUNCTION thermal_cond_tot_y

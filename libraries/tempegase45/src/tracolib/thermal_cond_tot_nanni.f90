REAL(kind=8) FUNCTION thermal_cond_tot_nanni(T_NEQ)
...
!*****************************************************************
    ...
    write(*,*)"thermal_cond_tot_nanni started"   
    ...
    thermal_cond_tot_nanni = k_trans + k_rot + k_vib + k_electronic &
   & + k_electron + k_reactive


END FUNCTION thermal_cond_tot_nanni

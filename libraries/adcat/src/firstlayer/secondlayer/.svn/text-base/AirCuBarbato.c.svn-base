...
#define nb_reactions 9                               //number of gas surface interactio reactions
...
void catc_aircubarbato_(int *nb_species, double moleproduction[*nb_species],double catalycities[4],double adsorbed_concentration[nb_adspecies],double *walltemperature,double gas_concentration[*nb_species],double molarmass[*nb_species]){
/*-------------------------------------------------------------------------------

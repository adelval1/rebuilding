#include<stdio.h>
#include<math.h>
void catc_airquartzbalat_(int nb_species, double concentration[nb_species],double  molarmass[nb_species],double walltemperature,double wallmoleproduction[nb_species]){
/*
Source:
\bibitem{b:b}  Balat, M.,
...
*/
	...
	catalycity=1.896*exp(-5042./walltemperature);
	...
	if(walltemperature<85||walltemperature>1430){
		printf("\n error:");
		printf("\n the catalysis model is valid in the range between 850 and 1430K");

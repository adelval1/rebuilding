...
void catc_airnibarbato_(int *nb_species, double moleproduction[*nb_species],double catalycities[4],double adsorbed_concentration[nb_adspecies],double *walltemperature,double gas_concentration[*nb_species],double molarmass[*nb_species]){
/*-------------------------------------------------------------------------------

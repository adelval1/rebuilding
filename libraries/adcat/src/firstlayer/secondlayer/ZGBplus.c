...
void catc_zgbplus_(int *nb_species,double catalycities[*nb_species],double adsorbed_concentration[nb_adspecies],double *walltemperature,double gas_concentration[*nb_species],double molarmass[*nb_species],double wallmoleproduction[*nb_species]){
...
Name of the Model:
ZGB plus (Ziff Gulari Barshad extented)
